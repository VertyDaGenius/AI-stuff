...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
    ...
    if choice =="1":
        ...
        while True:
            ...
            if response.strip() == "":
                print(' ')
                print(color + "ProtoBot: Sowwy, protobot couldnt think of a response to generate :( try asking the question again.")
                print(' ')
            else:
                transformed_response = transform_response(response)
                print(' ')
                print(color + "ProtoBot: " + transformed_response)
                print(' ')
